...
BASE_PATH=/laboptima-labios.ufrj.br/ pnpm --filter @workspace/lab-website run build
...
git remote add origin "https://engphb:$GITHUB_PERSONAL_ACCESS_TOKEN@github.com/engphb/laboptima-labios.ufrj.br.git"
...
echo "   https://engphb.github.io/laboptima-labios.ufrj.br/"
