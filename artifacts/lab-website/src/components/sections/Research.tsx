    ...
    <section id="pesquisa" className="py-24 bg-slate-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center max-w-3xl mx-auto mb-16">
          <h2 className="text-primary font-semibold tracking-wide uppercase text-sm mb-3">Nossa Ciência</h2>
          <h3 className="text-4xl font-display font-bold text-slate-900 mb-6">Linhas de Pesquisa</h3>
              ...
              >
                ...
                <div className="relative z-10">
                  ...
                  <a href="#contato" className="inline-flex font-medium text-primary mt-6 hover:text-accent transition-colors group-hover:underline underline-offset-4">
                    Saiba mais sobre projetos em andamento &rarr;
                  </a>
                </div>
              </motion.div>
            );
